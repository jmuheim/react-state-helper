...
- [ ] Any new wrapper variable is added to the variable table in `docs/mobilecoach-admin-guide.md` **and** declared in MobileCoach (default value `0`, access "manageable by service") before deploy.
