...
> Refined by #49: the dedicated `$rsh_completionOverview` variable is dropped — the overview (format unchanged) is appended to `$participantGroup` instead.
