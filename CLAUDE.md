...
- `docs/mobilecoach-author-guide.md` — for **MobileCoach Authors** (people who only fill the created dialogs with content); currently a stub pointing to the MobileCoach Admin guide, a new, focused guide is planned.
